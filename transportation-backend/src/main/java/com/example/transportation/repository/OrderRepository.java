...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT o FROM Order o JOIN o.cargos c GROUP BY o.id ORDER BY COUNT(c) DESC")
    Page<Order> findAllOrderByCargosCountDesc(PageRequest pageRequest);

    @Query("SELECT o FROM Order o JOIN o.cargos c GROUP BY o.id ORDER BY COUNT(c) ASC ")
    Page<Order> findAllOrderByCargosCountAsc(PageRequest pageRequest);
}

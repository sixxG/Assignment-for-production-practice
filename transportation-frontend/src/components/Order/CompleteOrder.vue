<template>
    <button type="button" v-on:click="completeOrder(id)" class="btn btn-success" style="margin-bottom: 5px;" data-toggle="tooltip" data-html="true" title="Завершить доставку">
